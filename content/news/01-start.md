...
_"We will bring your hardware development experience to the next level: you can not only use your favorite functional hardware description language [Clash](https://clash-lang.org) to create hardware designs, but at the same time you can utilize the power of its functional language design to easily connect with formal verification tools such as proof assistants or SMT solvers."_
